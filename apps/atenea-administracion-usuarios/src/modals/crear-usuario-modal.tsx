        ...
        {success ? (
          ...
          <div className="text-center">
            ...
            <p className="mt-5 text-[15px] text-ink/75">
              Se creará el usuario con el correo corporativo:
            </p>
            ...
            <div className="mt-5 flex items-center gap-2.5 rounded-xl border border-[#0F3B66] bg-[#EAF2FF] px-3.5 py-3 text-left">
              <span
                ...
                aria-hidden
              >
                <i className="pi pi-info-circle text-[16px] leading-none text-white aria-hidden absolute! top-1/2! left-1/2! -translate-x-1/2! -translate-y-1/2!" />
              </span>
              <p className="text-[13px] leading-snug text-[#0F3B66]">
                Se le enviará un correo electrónico al usuario nuevo con las
                credenciales para validar su cuenta y poder cambiar su
                contraseña.
              </p>
            </div>
