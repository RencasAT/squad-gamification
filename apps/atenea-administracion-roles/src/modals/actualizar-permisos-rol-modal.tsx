...
type ActualizarPermisosRolModalProps = {
  open: boolean;
...
export function ActualizarPermisosRolModal({
  open,
  roleName,
  onClose,
  onConfirm,
}: ActualizarPermisosRolModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center p-4">
      ...
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="actualizar-permisos-rol-title"
      ...
      >
        ...
        {success ? (
          <div className="flex min-h-55 flex-col items-center justify-center py-6 text-center animate-[success-fade_0.35s_ease-out]">
            <SuccessCheckIcon />
            <h2
              id="actualizar-permisos-rol-title"
          ...
          <div className="text-center">
            ...
            <p className="mt-5 text-[15px] text-ink/75">
              Se actualizarán los permisos de rol:
            </p>
            ...
            >
              {submitting ? 'Actualizando...' : 'Aceptar'}
            </Button>
          </div>
        )}
      </div>
